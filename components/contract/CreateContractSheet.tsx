...
export default function CreateContractSheet({ open, onOpenChange, onSuccess }: CreateContractSheetProps) {
        ...
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent className="w-[400px] sm:w-[540px] overflow-y-auto">
                <SheetHeader>
                    ...
                    <SheetDescription>
                        Fill in the details below to initialize a new contract request.
                    </SheetDescription>
                </SheetHeader>
